...
def _(compile_nmodl, h, os, shutil):
    ...
    for _filename in files:
        if _filename.endswith(".mod"):
            shutil.copyfile(
                f"./../src/{_filename}",
                f"venv/Lib/site-packages/pyNN/neuron/nmodl/{_filename}",
            )
    compile_nmodl("../.venv/Lib/site-packages/pyNN/neuron/nmodl")
    h.nrn_load_dll("venv/Lib/site-packages/pyNN/neuron/nmodl/mn.o")
    return
...
def _(
    ...
    for ref in refs:
        ...
        _filename = os.path.join(new_folder, f"Ca_forca_ref{ref}_Umax=2000.csv")
        ...
        _filename = os.path.join(new_folder1, f"Ca_spike_data_ref_{ref}_Umax=2000.csv")
        ...
        _filename = os.path.join(new_folder2, f"Ca_cell_spike_ref_{ref}_Umax=2000.csv")
